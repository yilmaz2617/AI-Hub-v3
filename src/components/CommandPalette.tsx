...
export default function CommandPalette() {
  const { showCommandPalette, setCommandPalette, toggleZenMode, toggleFullscreen, setCompareMode } =
    useUIStore();
    ...
    () => [
      {
        id: 'chat',
        title: 'Sohbet Paneli',
        subtitle: 'AI modelleri ile sohbet et',
        icon: MessageSquare,
        shortcut: 'Ctrl+1',
        action: () => {
          setPanel('chat');
        ...
        keywords: ['sohbet', 'chat', 'mesaj', 'gpt', 'ai'],
      },
      {
        id: 'premium',
        title: 'Premium Free',
        subtitle: 'En iyi ücretsiz modeller',
        icon: Crown,
        shortcut: 'Ctrl+2',
        action: () => {
          setPanel('premium');
        ...
        keywords: ['premium', 'free', 'gpt-4o', 'claude'],
      },
      {
        id: 'image',
        title: 'Görsel Üretimi',
        subtitle: 'AI ile görsel oluştur',
        icon: Image,
        shortcut: 'Ctrl+3',
        action: () => {
          setPanel('image');
        ...
        keywords: ['gorsel', 'image', 'resim', 'foto', 'flux'],
      },
      {
        id: 'status',
        title: 'API Durumu',
        subtitle: 'API anahtarlarını yönet',
        icon: Wifi,
        shortcut: 'Ctrl+4',
        action: () => {
          setPanel('status');
        ...
        keywords: ['api', 'key', 'durum', 'status'],
      },
      {
        id: 'improve',
        title: 'Kendini Geliştir',
        subtitle: 'AI ile kodunu iyileştir',
        icon: Zap,
        shortcut: 'Ctrl+5',
        action: () => {
          setPanel('improve');
        ...
        keywords: ['gelistir', 'improve', 'kod', 'optimize'],
      },
      {
        id: 'compare',
        title: 'Karşılaştırma Modu',
        subtitle: 'İki modeli aynı anda test et',
        icon: Columns,
        action: () => {
          setCompareMode(true);
          setCommandPalette(false);
        },
        keywords: ['karsilastir', 'compare', 'iki', 'test'],
      },
      {
        id: 'zen',
        title: 'Zen Modu',
        subtitle: 'Dikkat dağıtıcıları gizle',
        icon: Monitor,
        action: () => {
          toggleZenMode();
          setCommandPalette(false);
        },
        keywords: ['zen', 'odak', 'focus'],
      },
      {
        id: 'fullscreen',
        title: 'Tam Ekran',
        subtitle: 'Tam ekran moduna geç',
        icon: Maximize,
        action: () => {
          toggleFullscreen();
          setCommandPalette(false);
        },
        keywords: ['fullscreen', 'tam ekran'],
      },
      {
        id: 'theme',
        title: `Tema: ${themeId}`,
        subtitle: 'Tema değiştir',
        icon: themeId === 'light' ? Sun : Moon,
        action: () => {
          toggleTheme();
          setCommandPalette(false);
        },
      ...
      },
      {
        id: 'help',
        title: 'Yardım',
        subtitle: 'Klavye kısayolları ve ipuçları',
        icon: HelpCircle,
        action: () => {
          setCommandPalette(false);
        },
        keywords: ['yardim', 'help', 'nasil', 'klavye'],
      },
    ],
    [
      setPanel,
